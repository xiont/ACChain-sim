...
func GetLatency(from int, to int) int64 {
	if settings.USING_MAX_MIN{
		var base int64 = int64(settings.LATENCY_MIN)
		var scale int64 = int64(settings.LATENCY_MAX-settings.LATENCY_MIN)
		return base + int64(settings.Rand.NextFloat64() * float64(scale))
